...
void MVElectionData::calculate_winners() {
    ...
    // Generate teMVrary data structure for tracking votes and max seats allowed
...
void MVElectionData::add_audit_header() {
  audit_log.add_line("Election Type: MV");
...
MVElectionData::MVElectionData(std::vector<Party*> parties, int total_seats,
                                 int total_ballots)
