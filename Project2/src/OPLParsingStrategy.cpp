...
OPLParsingStrategy::OPLParsingStrategy()
{}

OPLParsingStrategy::~OPLParsingStrategy()
{}

ElectionData* OPLParsingStrategy::create_election(std::vector<std::string> ballots) {
    ...
    for (const auto& party : opl_parties) {
...
std::vector<std::tuple<std::string, Candidate*>> OPLParsingStrategy::create_OPL_candidates(std::ifstream& file, int numCands) {
...
void OPLParsingStrategy::assign_votes_to_candidates(std::ifstream& file, std::vector<Candidate*> candidates) {
    std::string line;
...
std::vector<Party*> OPLParsingStrategy::create_OPL_parties(std::vector<std::tuple<std::string, Candidate*>> candidates) {
